...
class simulation(App):
    def build(self):
        ...
        self.title_label = Label(text="simulation.py", height=50, bold=True, font_size=50, color=(0, 0.5, 1, 0.8))
        self.layout.add_widget(self.title_label)
        self.data = self.load_json_data("/Users/riccardo/github/Coding/config/simulation.json")
        self.text_inputs = {}
        ...
        spacer = Widget(size_hint_y=None, height=400)
    ...
    def save_json(self, instance):
        ...
        try:
            with open('/Users/riccardo/github/Coding/config/simulation.json', 'w') as outfile:
